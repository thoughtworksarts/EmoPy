...
feature_images = d.get_image_features(from_csv=False, dataset_location=root_directory, target_image_dims=(128,128), label_index=0, image_index=1, vector=True, time_series=True)
